...
public class ControleLeilaoTest {
    ...
    @Test
    public void deveRetornaVerdadeiroParaOPrimeiroLanceDoLeilaoMaiorQueOValorMinimo(){
        leilao.adicionarLance(new Lance(cliente, 2800));
        Lance novoLance = new Lance(cliente2, 2850);
        boolean validadeRetornada = controle.validarLance(novoLance, leilao);
        boolean validadeEsperada = true;
        assertEquals(validadeEsperada, validadeRetornada);
    }
    @Test
    public void deveRetornaFalsoParaUmNovoLanceMenorQueOLanceAnterior(){
    ...
    @Test
    public void deveRetornaFalsoParaUmnovoLanceIgualQueOLanceAnterior(){
        leilao.adicionarLance(new Lance(cliente, 3000));
        Lance novoLance = new Lance(cliente2, 3000);
        boolean validadeRetornada = controle.validarLance(novoLance, leilao);
        boolean validadeEsperada = false;
        assertEquals(validadeEsperada, validadeRetornada);
    }
